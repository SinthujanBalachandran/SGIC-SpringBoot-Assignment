...
import com.example.Spring_Boot_Defect_Tracker.exception.ResourceNotFoundException;
...
public class ProjectController {
	...
	public Project getProjectById(@PathVariable(value = "id") Long id) {
	    return ProjectRepositories.findById(id).orElseThrow(() -> new ResourceNotFoundException("Project", "id", id));
	}
